...
<body>
  <div class="wrap">
    ...
    <!-- Footer -->
    <footer style="margin-top: 40px; padding-top: 24px; border-top: 1px solid var(--line); text-align: center; font-size: 13px; color: var(--muted); display: flex; justify-content: center; align-items: center; gap: 12px; flex-wrap: wrap;">
      <span>© 2026 AI Code Scanner. Created by <a href="https://github.com/mehulk05" target="_blank" style="color: var(--neon-cyan); text-decoration: none; font-weight: 600;">Mehul Kothari</a>. All rights reserved.</span>
      <span style="color: var(--line); height: 12px; border-left: 1px solid var(--line); display: inline-block;"></span>
      <a href="https://github.com/mehulk05/ai-code-attribution-tracker" target="_blank" style="color: var(--muted); text-decoration: none; display: inline-flex; align-items: center; gap: 6px; transition: color 0.2s;" onmouseover="this.style.color='#0df'" onmouseout="this.style.color='var(--muted)'">
        <svg height="16" width="16" viewBox="0 0 16 16" fill="currentColor" style="display: inline-block; vertical-align: middle;">
          <path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.35 3.12.9.01.64.01 1.24.01 1.38 0 .21-.15.46-.55.38A8.013 8.013 0 0 1 0 8c0-4.42 3.58-8 8-8z"/>
        </svg>
